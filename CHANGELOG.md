...
## [4.0.4](https://github.com/Girsi/fantasy-statblocks/compare/v4.7.8...4.0.4) (2024-10-11)
...
* Adds a Creature pane with search bar (close [#256](https://github.com/Girsi/fantasy-statblocks/issues/256)) ([fca9c5a](https://github.com/Girsi/fantasy-statblocks/commit/fca9c5aae69a2127569fc83b9bb330a12c98e3ba))
* Adds ability to append to properties by specifing `property+` in a codeblock ([d84b872](https://github.com/Girsi/fantasy-statblocks/commit/d84b872207938a58cf81ef7587c3e0f8a1551267))
* Adds ability to open note-based creatures directly from the bestiary in settings ([4669df8](https://github.com/Girsi/fantasy-statblocks/commit/4669df8c73c026e1fd0fb04905b841d79cff6e14))
* Adds Column settings in the Advanced pane of the Layout Editor ([0193fad](https://github.com/Girsi/fantasy-statblocks/commit/0193fad4f1b16363245696efec488fbf5d6abb35))
* Adds in ability to override Spellcasting trait name (close [#138](https://github.com/Girsi/fantasy-statblocks/issues/138)) ([c9bc086](https://github.com/Girsi/fantasy-statblocks/commit/c9bc086955c8f2c48dfdcf468021842c6ce49cd4))
* Adds layout suggestor (close [#226](https://github.com/Girsi/fantasy-statblocks/issues/226)) ([cf568d8](https://github.com/Girsi/fantasy-statblocks/commit/cf568d809d50872b94d93d4285948644a24ade90))
* Adds Mythic Description in the Basic 5e Layout ([15e137d](https://github.com/Girsi/fantasy-statblocks/commit/15e137d244d6f950b361294bccc5041414948ba9))
* Adds new methods to the API to transform Statblock Links back to Obsidian links ([fb80517](https://github.com/Girsi/fantasy-statblocks/commit/fb805170330ee64073f0c4ad58c53544c805fc51))
* Adds Obsidian protocol handler `creature-pane` to open Creature Pane via an Obsidian link. Usage: `obsidian://creature-pane?creature=&lt;name&gt;` ([dee46de](https://github.com/Girsi/fantasy-statblocks/commit/dee46deabdc8a02b78d3da8118504f763f0fb9f2))
* Adds proper API typings for npm module ([dbf6b7d](https://github.com/Girsi/fantasy-statblocks/commit/dbf6b7db5ec4b466d458ba15cf1a47abc241200e))
* Adds support for importing from PF2eMonsterTool ([df7f7f3](https://github.com/Girsi/fantasy-statblocks/commit/df7f7f3f04ba37f019ff3c09b0e14e54786bc443))
* Allow markdown formatting in trait names (close [#428](https://github.com/Girsi/fantasy-statblocks/issues/428)) ([#430](https://github.com/Girsi/fantasy-statblocks/issues/430)) ([dec459c](https://github.com/Girsi/fantasy-statblocks/commit/dec459cb1be8cbb7cb7be73cfd2362a69a534208))
* Begin moving towards an API-based approach ([1cfcef8](https://github.com/Girsi/fantasy-statblocks/commit/1cfcef8a9fc9e964d008df269f39c7724325003c))
* Can now specify a css class to apply to every nested element inside a group container (close [#173](https://github.com/Girsi/fantasy-statblocks/issues/173)) ([3c5509c](https://github.com/Girsi/fantasy-statblocks/commit/3c5509c681b2ec364d0549f4ec961ff5e0310923))
* Create a 13th Age monster layout ([#206](https://github.com/Girsi/fantasy-statblocks/issues/206)) ([bafb2a0](https://github.com/Girsi/fantasy-statblocks/commit/bafb2a04effb8634a705089117d8cf5dae947448))
* Creatures from notes are no longer saved to data. ([1f08a96](https://github.com/Girsi/fantasy-statblocks/commit/1f08a9608016da3938d7e855a3ae6f5ff7232690))
* Enable property callbacks on traits ([e643ae6](https://github.com/Girsi/fantasy-statblocks/commit/e643ae6b73df2ca529bf1fd9b7e0da679516c8ca))
* Enables Layout-specific dice parsing using Regular Expressions and callbacks ([a6f482b](https://github.com/Girsi/fantasy-statblocks/commit/a6f482b67db5606bda26b45915876454a793f493))
* Enables searching by field in creature pane using `@&lt;field&gt; <search>` ([45760aa](https://github.com/Girsi/fantasy-statblocks/commit/45760aa966af6ad4061c45ff27e34d79d65660fe))
* Exposes some basic color settings for Layouts ([1716230](https://github.com/Girsi/fantasy-statblocks/commit/17162304eff3ec4f3f251619ccd953b76b1bd057))
* Extract monster subtypes from 5e.tools tags ([9f8bf4e](https://github.com/Girsi/fantasy-statblocks/commit/9f8bf4e5430015513bffca71d66deb8e85e3e511))
* Full transition to new Bestiary API ([0c58550](https://github.com/Girsi/fantasy-statblocks/commit/0c5855071afa9d4c8509ecea6055f75218c228ea))
* New `bestiary` field can be set to false to prevent creature from being exposed in the bestiary. Note that if another creature extends this, you should set `bestiary` to true. ([2ed4c9c](https://github.com/Girsi/fantasy-statblocks/commit/2ed4c9cc4ddb2f1927d06ea19385af01dbcfb78d))
* New Action block for layouts enables in-layout buttons ([982a690](https://github.com/Girsi/fantasy-statblocks/commit/982a6909270657bcb3367b4fb4d1fdbaf3277101))
* New editor suggester that dynamically loads layout fields to suggest properties in code blocks ([0064bfe](https://github.com/Girsi/fantasy-statblocks/commit/0064bfe883304fc77eafa498e9847d9d8a83d6bf))
* New IT encounter buttons for 5e layout ([b57f315](https://github.com/Girsi/fantasy-statblocks/commit/b57f315b3d0e3cc1607bbc95b6d6ca4a82c96dd7))
* New Layout Editor experience on Desktop / Tablet ([6d017c6](https://github.com/Girsi/fantasy-statblocks/commit/6d017c68af30e6f7f32aa5388dc7ea062e3d3059))
* New UI for Bestiary creatures in settings ([b6063aa](https://github.com/Girsi/fantasy-statblocks/commit/b6063aa05b0b3bbbff63e18aee37a5a131c4570f))
* npm release ([78016ea](https://github.com/Girsi/fantasy-statblocks/commit/78016ea8e5154ed1115fa83e0978039b94c214f9))
* Pass the current property as a parameter for trait callbacks ([#432](https://github.com/Girsi/fantasy-statblocks/issues/432)) ([c9475de](https://github.com/Girsi/fantasy-statblocks/commit/c9475def0df2ce3919ee4d263f461bd5da8b3a3d))
* Revamps Appearance pane of the Layout Editor ([0193fad](https://github.com/Girsi/fantasy-statblocks/commit/0193fad4f1b16363245696efec488fbf5d6abb35))
* Spells can now also auto-link to aliases of files ([d666d57](https://github.com/Girsi/fantasy-statblocks/commit/d666d57b188c5893a9ca6b6f5a9f332ab887e30e))
* Statblocks will now attempt to self-update when the monster they are rendering has been updated. ([b7731ef](https://github.com/Girsi/fantasy-statblocks/commit/b7731efea9d3aaf13aead6966382d7a6c51951fb))
* Text content is now rendered as markdown by default. The "Render as Markdown" option has been removed. ([fb58048](https://github.com/Girsi/fantasy-statblocks/commit/fb580482d1764b1132d6661d5ffcdbc961e76ffb))
* Traits are now nestable (close [#174](https://github.com/Girsi/fantasy-statblocks/issues/174)) ([d4ad0b4](https://github.com/Girsi/fantasy-statblocks/commit/d4ad0b49088a9f01527683a9a241e7c91ef4b535))


### Bug Fixes

* action block editor allows saving now ([98929f0](https://github.com/Girsi/fantasy-statblocks/commit/98929f08f1c474dcdf878afe3a0167fa833b6a6f))
* Actions will now actually execute ([ece1f43](https://github.com/Girsi/fantasy-statblocks/commit/ece1f4339973bb10bab947728c4c2ea24559fed1))
* Add ability to add examples for dice parsers for future reference ([e1d365c](https://github.com/Girsi/fantasy-statblocks/commit/e1d365c4d36d68a28863738b2e725820cbed99ad))
* Add bestiary key to included SRD ([95af431](https://github.com/Girsi/fantasy-statblocks/commit/95af431d280124570d7fb7a516488f03b0eeb4f3))
* add bestiary names method to API spec ([7a0c509](https://github.com/Girsi/fantasy-statblocks/commit/7a0c509fe593d3af261aa7b5051d8310adc792bf))
* add notice to aid with mobile debugging ([6002832](https://github.com/Girsi/fantasy-statblocks/commit/6002832010916d719d6fbad4f77ed1d87a20e937))
* add option to disable CSS class adding of property names ([c707c3c](https://github.com/Girsi/fantasy-statblocks/commit/c707c3cd5db1194c74f3de06514d4478d56a9d96))
* add repo Update release-please.yml ([1383431](https://github.com/Girsi/fantasy-statblocks/commit/1383431ca78f7a6c741a79ecf4fafe78853ab753))
* Added "Delete filtered creatures" button to Bestiary in settings ([ea238e3](https://github.com/Girsi/fantasy-statblocks/commit/ea238e3b5ddbbcfbf8e3d76a612ff3d208a7d1ba))
* Added isResolved, onResolved and onUpdated API hooks ([8d3b1e9](https://github.com/Girsi/fantasy-statblocks/commit/8d3b1e959a5bf751230f98bddf6cc8ded9a0f4be))
* Adds `extends` to the statblock editor suggest ([39067b0](https://github.com/Girsi/fantasy-statblocks/commit/39067b0073d1641e38423c2d9f3e62b4ac738b43))
* adds fate core css (close [#217](https://github.com/Girsi/fantasy-statblocks/issues/217)) ([3ddd501](https://github.com/Girsi/fantasy-statblocks/commit/3ddd501c1a6323dd4cc015df3d1b958344b9153d))
* Adds in PF2e specific dice parsers (close [#357](https://github.com/Girsi/fantasy-statblocks/issues/357)) ([1449d79](https://github.com/Girsi/fantasy-statblocks/commit/1449d79e2b2e8a3411551f31e58a97a3b37e4e26))
* adds link italics css variable ([4c8050c](https://github.com/Girsi/fantasy-statblocks/commit/4c8050c582a1f07cf6db1efa2d4496797a611094))
* adds new bestiary api hooks ([c395ab8](https://github.com/Girsi/fantasy-statblocks/commit/c395ab8f32aa6d2fc6d0217490c02adc32cbf402))
* Adds new Creature pane commands: Reveal existing, Open new ([81a9491](https://github.com/Girsi/fantasy-statblocks/commit/81a9491a9d69c8928e104485ba0eb512e12a3920))
* Adds Regional Effects to the Basic 5e Statblock ([8274249](https://github.com/Girsi/fantasy-statblocks/commit/82742497a697bcbdb1b4d9ef94145d91261242dc))
* Adds rotation animation for CSS ([7df6249](https://github.com/Girsi/fantasy-statblocks/commit/7df624977dc8bf63f808ae3b8f9602b90eacab47))
* Adds several missed fields to the TetraCube import ([4eb00cd](https://github.com/Girsi/fantasy-statblocks/commit/4eb00cd8ec7a7708fae3c3164691a6550fdf81f5))
* Adds source field to 5e SRD bestiary ([7b3da4c](https://github.com/Girsi/fantasy-statblocks/commit/7b3da4c032b693f10eae041894a19fe663963d96))
* Adds support for the `ac_class` property ([8e9e26b](https://github.com/Girsi/fantasy-statblocks/commit/8e9e26ba428dfefe01424b21d6ded60e7fed0587))
* Adds Theme toggles to Previewer in Layout Editor ([e531fe8](https://github.com/Girsi/fantasy-statblocks/commit/e531fe8d0b782587b8cb0999c30e92d9313dc4b3))
* allow for updating default layouts if no changes have been made ([65c7402](https://github.com/Girsi/fantasy-statblocks/commit/65c74022862755a8baed91d8f91c91da72e6f5a6))
* Allow space as a separator for subheadings ([37126dd](https://github.com/Girsi/fantasy-statblocks/commit/37126dd1cb738713b02be7d84b71af48cdc7b792))
* Allows Group blocks to be set conditional ([d07b6ec](https://github.com/Girsi/fantasy-statblocks/commit/d07b6ecc39cd7bff9c881ed80ccc7262ac4bb792))
* Attempt to speed up initial FS parsing ([51a31ae](https://github.com/Girsi/fantasy-statblocks/commit/51a31aee1af24593cc9c6ff011fcea5fe598cc68))
* basic 5e layout now shows 10xp for 0cr creatures ([e6e9bb3](https://github.com/Girsi/fantasy-statblocks/commit/e6e9bb3fde33bad21ef67f90a8433b47535274b2))
* beep boop ([0d942df](https://github.com/Girsi/fantasy-statblocks/commit/0d942dfc9da30512faac7982d7838ebb09c62be3))
* Bestiary resolved events will re-fire after the vault is re-parsed ([2c8c8c7](https://github.com/Girsi/fantasy-statblocks/commit/2c8c8c77a657c3b161cb67bd4ccfc4b0e28450f5))
* Better scoping for BnB css ([297e2be](https://github.com/Girsi/fantasy-statblocks/commit/297e2be8415979ce86b9cfe127e53a76a59880df))
* Better styling for combatant pane search ([f96297a](https://github.com/Girsi/fantasy-statblocks/commit/f96297afad075ab008e2156adbcf76682ed4170b))
* bump 5e layout version ([539a049](https://github.com/Girsi/fantasy-statblocks/commit/539a04908cc01950b0c581fd68fe5224f8a8d845))
* Check for `hit_dice` property in `hp` dice callback for the Basic 5e Layout ([fb2bbe6](https://github.com/Girsi/fantasy-statblocks/commit/fb2bbe6672c23681c8ab970a6d926aacccbcee93))
* Clean up dead plugin code ([3df6baf](https://github.com/Girsi/fantasy-statblocks/commit/3df6baf3c6e5f0503b07135b936f793f6703f6d3))
* Correctly parses links for frontmatter creatures ([b182d8f](https://github.com/Girsi/fantasy-statblocks/commit/b182d8f2de36471cf3c39557cf9eed4417d4e32b))
* Creature notes no longer overwrite codeblock parameters (close [#243](https://github.com/Girsi/fantasy-statblocks/issues/243)) ([78fa44e](https://github.com/Girsi/fantasy-statblocks/commit/78fa44ec10da203df97b329fddf232803ca08bae))
* Creature pane ribbon button will now open a new pane with a `mod`-click (cmd/ctrl) ([a4ba38a](https://github.com/Girsi/fantasy-statblocks/commit/a4ba38a55adf4dff59eece19da6d7b876440954e))
* Creature pane will now intelligently open new panes alongside existing ones (close [#342](https://github.com/Girsi/fantasy-statblocks/issues/342)) ([3040013](https://github.com/Girsi/fantasy-statblocks/commit/30400131a343addffad068bdb1729eee8af64be3))
* creatures always show prop if not redefined, re-implement saves addition ([1bc9945](https://github.com/Girsi/fantasy-statblocks/commit/1bc9945fc5d7d84d6c43404bd3dfb2ae58087cab))
* **css:** add consistency to css variables for statblocks ([#369](https://github.com/Girsi/fantasy-statblocks/issues/369)) ([6731d73](https://github.com/Girsi/fantasy-statblocks/commit/6731d7351d68a0bcdfbbf5645d199ff85823f4fd))
* **css:** prioritize pf2e icons over system font ([#420](https://github.com/Girsi/fantasy-statblocks/issues/420)) ([4de2457](https://github.com/Girsi/fantasy-statblocks/commit/4de2457cdd8b2a91fb99e8a794b489e297ca9ccf))
* default layout resets correct layout (close [#172](https://github.com/Girsi/fantasy-statblocks/issues/172)) ([fe3a6b9](https://github.com/Girsi/fantasy-statblocks/commit/fe3a6b96fb587ea7ce723fddd3286189f0af472a))
* Deleting a monster now actually removes it from the data file before saving ([92c1402](https://github.com/Girsi/fantasy-statblocks/commit/92c1402e9b70b7fb1c67400d9ab1e7cafefe90a1))
* Deleting a monster should now save ([e81a00f](https://github.com/Girsi/fantasy-statblocks/commit/e81a00fb0723617c9e847d8beea6d22953034af3))
* Dice callbacks should now correctly execute even if parse dice is off ([1602e6c](https://github.com/Girsi/fantasy-statblocks/commit/1602e6ca02effbacf12fb3c8a060b51dde2e60e6))
* Dice Callbacks will no longer try to execute if Dice Roller is not enabled ([5ec4019](https://github.com/Girsi/fantasy-statblocks/commit/5ec40198276c570903d8d9d2d8a0606a9a5b9db9))
* Disable API spec generation ([5dc8165](https://github.com/Girsi/fantasy-statblocks/commit/5dc81652333cf020d2d07dcb5f284edc29110465))
* don't register popover for image if no image file exists ([e0dbcb7](https://github.com/Girsi/fantasy-statblocks/commit/e0dbcb7eb40db90147069d18daf5bd6d99637350))
* Enable section headings on inline groups ([e755ef4](https://github.com/Girsi/fantasy-statblocks/commit/e755ef4bd2c8269ebf4668ddf7fb9f893e103c23))
* ensure text is stringified ([d953ebb](https://github.com/Girsi/fantasy-statblocks/commit/d953ebb6023e5910200fd9c38078227de7819c72))
* expose bestiary in API ([7de02d3](https://github.com/Girsi/fantasy-statblocks/commit/7de02d3c6f06a633db914098eed1ecf5565480a8))
* Expose Section Heading border color in layout editor ([9fdba90](https://github.com/Girsi/fantasy-statblocks/commit/9fdba9074730eefff384c28210355c9370d6769b))
* Expose the monster on Table ability modifier calculation callbacks ([7bad5f2](https://github.com/Girsi/fantasy-statblocks/commit/7bad5f2981a587417be156f8d2f1a8c265e55a75))
* Extended/saved creatures can now remove traits ([a5a0141](https://github.com/Girsi/fantasy-statblocks/commit/a5a014145b58d79598e49c2592ccfc63cedaa00d))
* fancy new discord notifications ([737c8fe](https://github.com/Girsi/fantasy-statblocks/commit/737c8fe3393d8dfc906cc1de4a058179bf2d62d9))
* Fix empty spells properties ([ab4d9b3](https://github.com/Girsi/fantasy-statblocks/commit/ab4d9b3fb4bd11e9ba71b1b5675494d9c43fa06d))
* fix issue where nested arrays were sometimes being interpreted as wikilinks ([844e6a6](https://github.com/Girsi/fantasy-statblocks/commit/844e6a60d8e0b738cb8fb6660b16058fa54d40a6))
* Fix issue where some creatures wouldn't be able to export as PNG ([92ffc68](https://github.com/Girsi/fantasy-statblocks/commit/92ffc68488f964546f28db19a49378539ccc89bd))
* Fix minimum CR XP (close [#92](https://github.com/Girsi/fantasy-statblocks/issues/92)) ([2a88d4e](https://github.com/Girsi/fantasy-statblocks/commit/2a88d4edf85e57ee32d47b82b53ff8cc262da94b))
* Fix spellcasting not looking at provided monster property ([0a2d654](https://github.com/Girsi/fantasy-statblocks/commit/0a2d6545e09e6beacff8340cf36e549025e71987))
* Fix stringifier incorrectly matching some links ([#435](https://github.com/Girsi/fantasy-statblocks/issues/435)) ([fe436d5](https://github.com/Girsi/fantasy-statblocks/commit/fe436d50da8e37612b0188be1b9f306043a9491e))
* fix trait overriding ([8ba0773](https://github.com/Girsi/fantasy-statblocks/commit/8ba0773fdfb662f9c392c74a44b94a9f58d7aeca))
* Fixes "Default Layout" setting not being respected until restart ([8f24d0d](https://github.com/Girsi/fantasy-statblocks/commit/8f24d0dc90b403c958edb5e1f43877e4cae3a314))
* Fixes "Start Encounter" IT button ([21b4cc9](https://github.com/Girsi/fantasy-statblocks/commit/21b4cc9e655c7199682e21060d37bd6ca58a920b))
* Fixes 5e.tools AC import not including additional AC info (close [#340](https://github.com/Girsi/fantasy-statblocks/issues/340)) ([6116540](https://github.com/Girsi/fantasy-statblocks/commit/61165403859cd13ac3f3fc92c0eb8f6636df8b2a))
* Fixes 5e.tools import text replacement ([59877b3](https://github.com/Girsi/fantasy-statblocks/commit/59877b32ee5b65c5c0a7edadacda42e14f8bbf49))
* Fixes additive string properties ([33b1a44](https://github.com/Girsi/fantasy-statblocks/commit/33b1a44f25bfbd6d2d9972cccd773afd0d9a8a05))
* Fixes appearance of parsed dice rolls in 5e ([153226e](https://github.com/Girsi/fantasy-statblocks/commit/153226e1752a7a64b27fb2695198640fcac61a88))
* fixes being unable to parse certain save roll syntaxes ([24e1696](https://github.com/Girsi/fantasy-statblocks/commit/24e16964b8c35fa6ddcae86c1c815b5145f54599))
* fixes crash when no statblock elements are created ([b2156fb](https://github.com/Girsi/fantasy-statblocks/commit/b2156fb08469b79bca5c351f5fbcb0c31ed47c9e))
* Fixes custom trait duplication (close [#222](https://github.com/Girsi/fantasy-statblocks/issues/222)) ([a281d5b](https://github.com/Girsi/fantasy-statblocks/commit/a281d5b034af9357f967c8afd2397a36a43770fd))
* fixes deletion of default layouts ([06f33d9](https://github.com/Girsi/fantasy-statblocks/commit/06f33d99ff192a85826e121be2089df186ce4226))
* Fixes dice parsing displaying incorrectly ([c626dd9](https://github.com/Girsi/fantasy-statblocks/commit/c626dd9a3244a4810e4032bb92971b5c9e07b0f2))
* Fixes error handling in Statblock parser ([c6f7e7d](https://github.com/Girsi/fantasy-statblocks/commit/c6f7e7d4858a21eeff298dba0f7e026874791894))
* Fixes error where array values added to the Bestiary index would be stringified as-is ([7cc3e4b](https://github.com/Girsi/fantasy-statblocks/commit/7cc3e4bf72c7da8faff03250176739df156f978d))
* Fixes extends behavior not preferring in-note parameters ([72cc62e](https://github.com/Girsi/fantasy-statblocks/commit/72cc62ea5f61a4ab8854c23a5f70a9bcbf372226))
* Fixes extra whitespaces between links ([#331](https://github.com/Girsi/fantasy-statblocks/issues/331)) ([9717c3c](https://github.com/Girsi/fantasy-statblocks/commit/9717c3cf31ca8e32c68724b85a82b98ac9d1f7e4))
* Fixes image blocks not resolving if a property other than `image` is used (close [#300](https://github.com/Girsi/fantasy-statblocks/issues/300)) ([d0a4b30](https://github.com/Girsi/fantasy-statblocks/commit/d0a4b30724bb70051b61dbc2f341d135a03489f8))
* fixes image rendering (close [#177](https://github.com/Girsi/fantasy-statblocks/issues/177)) ([f5aa7af](https://github.com/Girsi/fantasy-statblocks/commit/f5aa7af974f1fd6b5e66a544aa76217acf440b1a))
* Fixes incorrect inheritance of certain properties (closes [#400](https://github.com/Girsi/fantasy-statblocks/issues/400)) ([e83b300](https://github.com/Girsi/fantasy-statblocks/commit/e83b30011bea0fa3002ee630ec2f423cc4723c52))
* fixes incorrect link parsing in the stringifier ([fbbf048](https://github.com/Girsi/fantasy-statblocks/commit/fbbf048ba551e4a1477c5c8235b9a0930fd03347))
* Fixes incorrect wording in settings ([96e1ead](https://github.com/Girsi/fantasy-statblocks/commit/96e1eadb9aff37cba908559010c15114da860bc7))
* Fixes instance where specifying a dice callback would override the dice settings for a statblock ([d60f6de](https://github.com/Girsi/fantasy-statblocks/commit/d60f6def9c442d1077b2fdf318b256c95c35700d))
* Fixes issue where an empty match array could cause the dice parser to fail ([be9aa85](https://github.com/Girsi/fantasy-statblocks/commit/be9aa85ad8e675e3dcbe22de5fe8c3ff9fa90ef0))
* Fixes issue where bestiary would never resolve if Parse Frontmatter was disabled ([16bfb03](https://github.com/Girsi/fantasy-statblocks/commit/16bfb0316b22f6bb9182ac2764f2182c1e5d432b))
* Fixes issue where creatures without an explicit name could cause the Bestiary to crash ([c7ea4ee](https://github.com/Girsi/fantasy-statblocks/commit/c7ea4ee57cf9ade417cdd16fb89e2a7de84ec2b8))
* Fixes issue where dice integration no longer works (close [#398](https://github.com/Girsi/fantasy-statblocks/issues/398)) ([447f8ab](https://github.com/Girsi/fantasy-statblocks/commit/447f8ab4e68dd673f4dd89ea58fc74558df25f4f))
* Fixes issue where dice parsing would consume +/- values ([200f787](https://github.com/Girsi/fantasy-statblocks/commit/200f787810aa747cf80195e4ae3219655f55a57c))
* Fixes issue where having DR installed but not enabled in FS would erroneously run dice callbacks ([2fa84c1](https://github.com/Girsi/fantasy-statblocks/commit/2fa84c1ba2c48a5b7c672724b271df466eefef05))
* Fixes issue where importing the same layout twice and deleting one would delete both ([9c189eb](https://github.com/Girsi/fantasy-statblocks/commit/9c189eb84a7186858ed5966dc7266b67657000ed))
* Fixes issue where margins around spells would be incorrect if multiple spell blocks were rendered (close [#337](https://github.com/Girsi/fantasy-statblocks/issues/337)) ([d90e8e1](https://github.com/Girsi/fantasy-statblocks/commit/d90e8e196b6c8a51067a0a1b18a9f81ba22c0f57))
* Fixes issue where modifying a default layout could duplicate it in the settings list ([35d7ab4](https://github.com/Girsi/fantasy-statblocks/commit/35d7ab42307a8b9fca147b3168f0d81d5854ecb5))
* Fixes issue where non-string properties would try to replace links ([0ee0330](https://github.com/Girsi/fantasy-statblocks/commit/0ee03309987bde67e34671929b852300dc70d0d6))
* Fixes issue where the Bestiary could resolve prematurely ([7668707](https://github.com/Girsi/fantasy-statblocks/commit/7668707ab337457dd74c478edf38494f93f1fb2a))
* Fixes issue where the default fallback for non-conditional blocks would cause a list to render (close [#409](https://github.com/Girsi/fantasy-statblocks/issues/409)) ([de5b6bf](https://github.com/Girsi/fantasy-statblocks/commit/de5b6bff8fa86f463aecb57da858f4e5b42c7ab4))
* Fixes issue where the folder suggester wasn't interactable ([df149c8](https://github.com/Girsi/fantasy-statblocks/commit/df149c8c24b03a113ba46c88789411e22e1862bb))
* Fixes issue where traits would be bold by default (close [#376](https://github.com/Girsi/fantasy-statblocks/issues/376)) ([4152ffa](https://github.com/Girsi/fantasy-statblocks/commit/4152ffa99efa5844a141e25e3154f6f800c94ecd))
* Fixes issue where trying to add a dice parser without any defined would crash the plugin ([0a60234](https://github.com/Girsi/fantasy-statblocks/commit/0a602342a031263c15b4238251f85f8d3a3ff48d))
* Fixes issue with dependency causing settings tab to not fully load ([b5f96c5](https://github.com/Girsi/fantasy-statblocks/commit/b5f96c538a24d178d3e6d4cf1894e0322251bcb1))
* Fixes issue with watcher not being able to parse some files ([1d625f7](https://github.com/Girsi/fantasy-statblocks/commit/1d625f79971ecaf8afc1a3c0f81d37f3bc9d2176))
* Fixes linkifying spells ([ae0a52b](https://github.com/Girsi/fantasy-statblocks/commit/ae0a52b33f3422de1a87eb87777c95bd3b5a225a))
* fixes multiline tables (breaks wikilinks in yaml style arrays coming from source...) ([79a29d1](https://github.com/Girsi/fantasy-statblocks/commit/79a29d1dd6df371798362897dc62adb29d67201e))
* fixes overload ([acd305d](https://github.com/Girsi/fantasy-statblocks/commit/acd305d4dc31e5d84116d7aa4b81cc6f6681d25f))
* Fixes Parse for Dice being on preventing dice callbacks ([6d08509](https://github.com/Girsi/fantasy-statblocks/commit/6d085093ef780bed4b46672bc1fe306db0ebc54c))
* fixes parsing wikilinks out of nested arrays in frontmatter ([f5676c2](https://github.com/Girsi/fantasy-statblocks/commit/f5676c251f0076619190840cb5981020d4a09436))
* fixes release target branch ([c477fe5](https://github.com/Girsi/fantasy-statblocks/commit/c477fe5d90a2a30b69dce3061b953f0484592dcc))
* fixes release, name change ([bae38ed](https://github.com/Girsi/fantasy-statblocks/commit/bae38ed33ac961d61db16e94adae22d16f222a52))
* fixes removing traits not working unless key is present ([1f3c8c1](https://github.com/Girsi/fantasy-statblocks/commit/1f3c8c1ec4e20a7eb3cb5ec9bdbca545ef16d665))
* fixes render function overwriting creature ([94a8a0a](https://github.com/Girsi/fantasy-statblocks/commit/94a8a0a1a27f3fef936945b62072448aefd0a65a))
* Fixes resolving markdown style links when URI encoded ([604f4d7](https://github.com/Girsi/fantasy-statblocks/commit/604f4d76411ab238200e01062df965ebf66de006))
* fixes saves / skillsaves not appearing ([98f79ab](https://github.com/Girsi/fantasy-statblocks/commit/98f79abd9c5749b060f2374bcbf7c0f6a1a58c81))
* Fixes scoping issue for Layout CSS in dark/light mode ([6f44db0](https://github.com/Girsi/fantasy-statblocks/commit/6f44db06ec33cc4fbe9ad5fdd74b0586bb5b5689))
* fixes slugify removing valid characters ([7769127](https://github.com/Girsi/fantasy-statblocks/commit/7769127f92580bc85917cb8385370770fa90874d))
* Fixes some bugs related to trait inheritance ([1814062](https://github.com/Girsi/fantasy-statblocks/commit/1814062b3927147255ae91ed7234a53a589b72ef))
* Fixes some dice parser errors ([#353](https://github.com/Girsi/fantasy-statblocks/issues/353)) ([35fb8a9](https://github.com/Girsi/fantasy-statblocks/commit/35fb8a9159939d28f1b013d52beb8a5057d37f87))
* Fixes spell itaclis ([#148](https://github.com/Girsi/fantasy-statblocks/issues/148)) ([022f7dc](https://github.com/Girsi/fantasy-statblocks/commit/022f7dc844665fdecfd489f0051bed0942205764))
* Fixes stringify skipping the sixth element of a list (close [#451](https://github.com/Girsi/fantasy-statblocks/issues/451)) ([7dbc4a9](https://github.com/Girsi/fantasy-statblocks/commit/7dbc4a9c99fb72a8c189513f13b778277cf37f88))
* fixes styling leaking to all links (close [#210](https://github.com/Girsi/fantasy-statblocks/issues/210)) ([fde0ead](https://github.com/Girsi/fantasy-statblocks/commit/fde0ead0a7fc7a8db8ab963c2ccf7ded24ea6fa4))
* Fixes subheading separator in basic 5e layout (close [#331](https://github.com/Girsi/fantasy-statblocks/issues/331)) ([1b21bd7](https://github.com/Girsi/fantasy-statblocks/commit/1b21bd7ad3c5bfb9f99694e3a7dfe97decaef8bc))
* Fixes subsequent paragraph display in markdown holders ([#148](https://github.com/Girsi/fantasy-statblocks/issues/148)) ([471e7da](https://github.com/Girsi/fantasy-statblocks/commit/471e7da9493b94737fb9f839f160ab6c5a545e86))
* Fixes table Ability Modifier callback input not being in the collapsible Advanced element ([427a05d](https://github.com/Girsi/fantasy-statblocks/commit/427a05d5224d9d343e1d24fc9312881a85962860))
* fixes table css class interference (close [#230](https://github.com/Girsi/fantasy-statblocks/issues/230)) ([a93264c](https://github.com/Girsi/fantasy-statblocks/commit/a93264c02b2ebafc026af0dbf83c0e7932c5c887))
* Fixes transforming of traits to overwrite existing traits (close [#156](https://github.com/Girsi/fantasy-statblocks/issues/156)) ([ed40a70](https://github.com/Girsi/fantasy-statblocks/commit/ed40a70ad37ab211efc0f0f7a791c43297c1c46f))
* fixes tsconfig ([ba26704](https://github.com/Girsi/fantasy-statblocks/commit/ba267046afbf9148b1861d85d2038f3eebb6ee37))
* Fixes typings for 5e Tools importer ([7d7125b](https://github.com/Girsi/fantasy-statblocks/commit/7d7125be4aba0a0ae69a081159419abceabb4010))
* Global switch to Lucide icons ([ddc2ea4](https://github.com/Girsi/fantasy-statblocks/commit/ddc2ea404e23e07a880087df871bf89ac517cf90))
* Improve behavior of self-updating feature ([7f8b84a](https://github.com/Girsi/fantasy-statblocks/commit/7f8b84ab14a53801f62413353fd39e6f9a0aa3f3))
* Improve Dice Parser UI in layout editor ([6115a6d](https://github.com/Girsi/fantasy-statblocks/commit/6115a6d6ec77fd82a686052babaeba8253e40fa3))
* Improves behavior of additive and reductive traits (close [#456](https://github.com/Girsi/fantasy-statblocks/issues/456), close [#421](https://github.com/Girsi/fantasy-statblocks/issues/421)) ([12df383](https://github.com/Girsi/fantasy-statblocks/commit/12df3838d5e755fa2f5aa66cf3188b3dab7a3754))
* Improves Bestiary event registration ([a0870e3](https://github.com/Girsi/fantasy-statblocks/commit/a0870e31fbfe09a1caf42fc6b9f2c7a0f60ccb1f))
* Improves help text for dice callbacks ([b69cc61](https://github.com/Girsi/fantasy-statblocks/commit/b69cc614509b73cac46ca60cccdf489511902aaa))
* Improves Previewer user experience ([05ec8c4](https://github.com/Girsi/fantasy-statblocks/commit/05ec8c4f1d8b7033bfb2141330b781309b4f7d91))
* Inherit default parsers into 5e Layout ([54d9061](https://github.com/Girsi/fantasy-statblocks/commit/54d90612d3db070c706813913e5c60b21074241d))
* Initialize Bestiary events hook before initializing file watcher ([08a1a5d](https://github.com/Girsi/fantasy-statblocks/commit/08a1a5d57e7cb902cecfcb3475766c0f4977a590))
* Inline Statblocks will now have their links transformed properly ([a15d5c2](https://github.com/Girsi/fantasy-statblocks/commit/a15d5c2f86dda2810626a3df76ee3cc65078fa78))
* inspect image property and fix wikilinks ([bbc4ac8](https://github.com/Girsi/fantasy-statblocks/commit/bbc4ac835717c4d987bb9dfc650e0fde32a51b65))
* Linkifying spells now ignores `*` ([26a1898](https://github.com/Girsi/fantasy-statblocks/commit/26a189896221a3acdf721e1df3410fe3a5e1ea8c))
* logs oops ([257bf4e](https://github.com/Girsi/fantasy-statblocks/commit/257bf4ecd5116d9e1d089b13476016dd1fe76a98))
* lumberjack attack (aka removed logs whoops) ([5cfbcf3](https://github.com/Girsi/fantasy-statblocks/commit/5cfbcf3827e448d2ce395fe10945b3fb28056244))
* made link stringifier stateless ([52672ce](https://github.com/Girsi/fantasy-statblocks/commit/52672ce01c2ac67d13910aaf333e31177b5a9e3a))
* New layouts will inherit default dice parsers by default ([59d8950](https://github.com/Girsi/fantasy-statblocks/commit/59d89500fe37a5f7b30795094a48ab6f5621063d))
* Normalize aliases on startup too ([d850b8f](https://github.com/Girsi/fantasy-statblocks/commit/d850b8f406e7c016271cd787af8513293a278b5a))
* normalize aliases when linkifying spells ([dd79164](https://github.com/Girsi/fantasy-statblocks/commit/dd79164856701643b2f160ae3c759c0b16ff3d45))
* Notify ObsidianTTRPG channel of releases ([d00b1bf](https://github.com/Girsi/fantasy-statblocks/commit/d00b1bfaa29d445ab1b7208bb0b3fea3ee89e97b))
* Pass table values through the markdown path ([1be6459](https://github.com/Girsi/fantasy-statblocks/commit/1be6459d3b4a18b1afd4f7a9f193249852d1da27))
* PF2e popover fix ([c7ebb18](https://github.com/Girsi/fantasy-statblocks/commit/c7ebb18df512ae65f261c1163f2e964a56696164))
* Plugin is now properly registered with the Page Preview plugin ([c1e9237](https://github.com/Girsi/fantasy-statblocks/commit/c1e9237f2f54c7e4c9e2bbbc286e9b032abf63cc))
* Position 3 dot menu relative to container (close [#364](https://github.com/Girsi/fantasy-statblocks/issues/364)) ([ef9c9f5](https://github.com/Girsi/fantasy-statblocks/commit/ef9c9f57efa2f727265cf22efecabc06ee2ab06c))
* Properly return the FS Bestiary unloaders ([004e43f](https://github.com/Girsi/fantasy-statblocks/commit/004e43ff60dc5d005038fe67856f31406dac2593))
* Properly scope Bunkers and Badasses css ([ccf0296](https://github.com/Girsi/fantasy-statblocks/commit/ccf0296fd4403a3a09e274ef2d47162e406aea80))
* Property lines now correctly stringify arrays ([9a27da8](https://github.com/Girsi/fantasy-statblocks/commit/9a27da8633640dd1759f992063cf8e5ae3af4a1a))
* re-add lock ([5df2898](https://github.com/Girsi/fantasy-statblocks/commit/5df289879aace49246dfc11e05f94402e684cb21))
* re-enable array-based traits ([ff31008](https://github.com/Girsi/fantasy-statblocks/commit/ff31008e4aac3242dfed068f90bdb371fef2b3f8))
* Remove duplicated API methods from plugin definition ([780ab18](https://github.com/Girsi/fantasy-statblocks/commit/780ab184661ff699d5a8dd858843170b820f8ae2))
* Remove latin alphabet requirement for css classes (close [#338](https://github.com/Girsi/fantasy-statblocks/issues/338)) ([79ada6c](https://github.com/Girsi/fantasy-statblocks/commit/79ada6cabf1ffcb41d17f3450c76e0c1eba95b3e))
* remove logs ([09d92e0](https://github.com/Girsi/fantasy-statblocks/commit/09d92e0209dce35db0b6afe81164e663fda5a8d6))
* remove logs ([7eebc67](https://github.com/Girsi/fantasy-statblocks/commit/7eebc67fed26def762f9790b40b8aede8ad1ee44))
* Remove outdated beta manifest ([1567fe5](https://github.com/Girsi/fantasy-statblocks/commit/1567fe5637be1dadd231010a5dc50d2b8f0226c1))
* Remove requirement to have Parse for Dice turned on to use Dice Callbacks ([a8bab50](https://github.com/Girsi/fantasy-statblocks/commit/a8bab50c31b46c455c9fb5158a68da9397b9da76))
* remove setImmediate so mobile works again ([a2ffe05](https://github.com/Girsi/fantasy-statblocks/commit/a2ffe05b744cfd22d53f6fc96e6ee3b9629af4fb))
* Remove single-view restriction on creature pane (close [#274](https://github.com/Girsi/fantasy-statblocks/issues/274)) ([7fad139](https://github.com/Girsi/fantasy-statblocks/commit/7fad13949367e205614002038e5dc6f431a659b4))
* remove ttrp ([59dd7a3](https://github.com/Girsi/fantasy-statblocks/commit/59dd7a37fe4ffd6c8072a3fc05b752ba283cc3cc))
* Remove unused components ([133c36e](https://github.com/Girsi/fantasy-statblocks/commit/133c36eaec4c0e920933e00e410415ca47d18ebe))
* Removed deprecated global app reference ([fde858b](https://github.com/Girsi/fantasy-statblocks/commit/fde858ba4f941cb6d7f4e8a8a7299b6c8b27b38c))
* removed logs ([c348c24](https://github.com/Girsi/fantasy-statblocks/commit/c348c2483041858058c1d28efdff21170f20e3bf))
* removes css import ([b874f6e](https://github.com/Girsi/fantasy-statblocks/commit/b874f6e1ce6535885247cb9d56971171db2aeb29))
* removes double newlines in SRD ([09fa166](https://github.com/Girsi/fantasy-statblocks/commit/09fa166399b0016c862ef7245452313172335be6))
* Removing a dice parser now saves properly (close [#382](https://github.com/Girsi/fantasy-statblocks/issues/382)) ([4219b98](https://github.com/Girsi/fantasy-statblocks/commit/4219b983d84b96268a4a09252ab8d8e766b1b257))
* Respect subheading separator in layouts ([0786e1f](https://github.com/Girsi/fantasy-statblocks/commit/0786e1fd17be99b4e66e3b881d6285cb28c08b09))
* Restrict creature pane to only creatures in bestiary ([010de61](https://github.com/Girsi/fantasy-statblocks/commit/010de612dfe13efb2b1d6dc91365067b55d6ec9f))
* Rewrite how traits are combined ([4685365](https://github.com/Girsi/fantasy-statblocks/commit/4685365f045621a3d9fc4c32a9e6433e2e51edc0))
* Saves blocks now use the `--statblock-property-name-font-color` css variable ([faf5da7](https://github.com/Girsi/fantasy-statblocks/commit/faf5da77b6502b8b628e38abebb598e85a75196e))
* Saves blocks will now allow strings (close [#267](https://github.com/Girsi/fantasy-statblocks/issues/267)) ([3bca930](https://github.com/Girsi/fantasy-statblocks/commit/3bca930b5f9238abd3bcb19a585187132bf0bf94))
* show hit_dice if dice roller not available in basic 5e layout ([eeacb9f](https://github.com/Girsi/fantasy-statblocks/commit/eeacb9f251ea770e0fe02abb70dcae367dc7966d))
* solves the bug that inhibits the property to be fully dice parsed ([#237](https://github.com/Girsi/fantasy-statblocks/issues/237)) ([27cf649](https://github.com/Girsi/fantasy-statblocks/commit/27cf6498590c714cc8905cbae39e29714571943a))
* Spells blocks can now be linked to properties ([1b37258](https://github.com/Girsi/fantasy-statblocks/commit/1b37258c02fefcbe5460ab2a4ed232fa31b65192))
* Subheadings should now properly stringify arrays ([5c3da30](https://github.com/Girsi/fantasy-statblocks/commit/5c3da3000736eb0560fafd088edefac43057dea1))
* Switch to centralized suggestion class ([2914658](https://github.com/Girsi/fantasy-statblocks/commit/29146587db7d0b9f6c6272109d1c9988b2f48db5))
* Switch to new dice roller module ([09a5047](https://github.com/Girsi/fantasy-statblocks/commit/09a50478836e4e602652ed86ebf4b392c2d4af07))
* Switches to @javalent/utilities ([f25e845](https://github.com/Girsi/fantasy-statblocks/commit/f25e845d3549c3b8327a02eed61b88a15dfca473))
* Sync to new Dice Roller API ([672dc8b](https://github.com/Girsi/fantasy-statblocks/commit/672dc8b979e9a637590d0e293181176ff9e77b2a))
* Syncs order of action buttons in the 5e layout with IT's encounter blocks ([f7d4675](https://github.com/Girsi/fantasy-statblocks/commit/f7d4675b9af9b00bd8bb3458320f9f477b080d56))
* temp fix for failure to load ([b3e4e21](https://github.com/Girsi/fantasy-statblocks/commit/b3e4e210f42a9bdf9fe8d0b69b0df42fea7b59c5))
* temp fix for not image block modal not opening ([f876bb5](https://github.com/Girsi/fantasy-statblocks/commit/f876bb518bcfdcc7e6833ccfb4984afc3d0ca598))
* Temporarily disable the Atomic Write functionality pending more investigation into data loss issues. ([97d38bc](https://github.com/Girsi/fantasy-statblocks/commit/97d38bc1dcb579f16231a935aa6948b8394e5acc))
* test ([90830d6](https://github.com/Girsi/fantasy-statblocks/commit/90830d6eb26d928aeefb6162ca342a7ea88e45cf))
* testing release webhook ([2ca8374](https://github.com/Girsi/fantasy-statblocks/commit/2ca83748ee359bdc0ad20df8d3faa6df5a68be38))
* testing release webhook 2 ([1183543](https://github.com/Girsi/fantasy-statblocks/commit/1183543d8ba3f66275a7f6a9c3589ec3f2313981))
* Traits respect inline groups now ([2a4c7b0](https://github.com/Girsi/fantasy-statblocks/commit/2a4c7b0ecb8dd8d5f5e178598b44fe9d603acb87))
* Traits will now properly display in inline groups ([385b0c0](https://github.com/Girsi/fantasy-statblocks/commit/385b0c0600513a262f7839025155e0b8ff6424b5))
* typo (close [#310](https://github.com/Girsi/fantasy-statblocks/issues/310)) ([8fe7242](https://github.com/Girsi/fantasy-statblocks/commit/8fe7242ddf96e5eb69e0d3e207fd9fc76fca1a92))
* unwrap callout blocks to find traits ([660a657](https://github.com/Girsi/fantasy-statblocks/commit/660a657981c25e65125f69d52162ee7d3f608b54))
* Update build ([c0543ed](https://github.com/Girsi/fantasy-statblocks/commit/c0543ed2ffe85a336be84d5c362373a506dd4bcd))
* Updated several outdated dependencies ([26f5355](https://github.com/Girsi/fantasy-statblocks/commit/26f53556e62a99f9c7da39b612839ceec6b452f6))
* Updates how default layouts are stored in the data file to reduce data file operations ([e1eb126](https://github.com/Girsi/fantasy-statblocks/commit/e1eb1267959d70ebf3942927a5fbfa0f2516c582))
* Use new Dice Roller API hook to commonize dice strings ([6798f78](https://github.com/Girsi/fantasy-statblocks/commit/6798f780bedd3245f8bc58e960d542bc2ce34606))
* Uses Dice Roller's average calculation instead of a rudimentary approach (close [#350](https://github.com/Girsi/fantasy-statblocks/issues/350)) ([5affff8](https://github.com/Girsi/fantasy-statblocks/commit/5affff80f5947f4409006c462f06e98251ce7f0d))
* watcher more intelligently chooses files to parse ([424f11f](https://github.com/Girsi/fantasy-statblocks/commit/424f11f2b8df0b0ab39d2902cbd485f51f151fea))
* YAML parsing respects monster key (close [#191](https://github.com/Girsi/fantasy-statblocks/issues/191)) ([78eaf40](https://github.com/Girsi/fantasy-statblocks/commit/78eaf4042d8f0ae75b2977f89045e4944eaff154))


### Miscellaneous Chores

* release 2.0.0 ([53779ef](https://github.com/Girsi/fantasy-statblocks/commit/53779ef133fa051e2301408edd4fc5658fb99c74))
* release 3.4.2 ([8450774](https://github.com/Girsi/fantasy-statblocks/commit/8450774eb70b4e056c6d931a6e5bf8d4051be29a))
* release 3.8.0 ([5d0f1c2](https://github.com/Girsi/fantasy-statblocks/commit/5d0f1c2f537d1fecb60b6a9b02f964864a20069f))
* release 3.8.0-b1 ([1b3aad7](https://github.com/Girsi/fantasy-statblocks/commit/1b3aad7fe670c124e5195f491f1568bb835a9123))
* release 4.0.4 ([0048de5](https://github.com/Girsi/fantasy-statblocks/commit/0048de5bc0385bdf2bb883852e5ab0708fd79954))
